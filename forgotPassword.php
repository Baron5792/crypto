...
<!-- Mirrored from trade.pro-cryptoinvestment.com/forgotPassword by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Mar 2024 12:13:52 GMT -->
...
<head>
    ...
    <body class="dt-header--fixed theme-dark dt-layout--full-width dt-sidebar--fixed o-auto">
            ...
            <div class="dt-login__content-wrapper">
                ...
                <div class="dt-login__bg-section">
                    ...
                    <div class="dt-login__bg-content">
                        <!-- Login Title -->
                        <h1 class="dt-login__title text-capitalize">Passwort vergessen</h1>
                        <!-- /login title -->

                        <p class="f-16 text-capitalize">Bitte geben Sie Ihre E-Mail-Adresse ein, um Ihr Passwort zurückzusetzen</p>
                    </div>
                ...
                <div class="dt-login__content">
                    <ul style="float: right;background-color: #1199FA;padding: 5px;">
                        <li class="dt-nav__item dropdown">
                            ...
                            <img style="width:20px;" class="flag-icon flag-icon-rounded flag-icon-lg mr-1m" src="uploads/germany.png">
                            <span>GE</span> </a>
                            <!-- /dropdown link -->
                            ...
                            <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(8px, 72px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                                <button class="dropdown-item sitelangChange" type="button" data-id="switchlang/English.html">
                                    <img class="flag-icon flag-icon-rounded flag-icon-lg mr-2" style="width: 20px;" src="uploads/gb-eng.png">
                                    <span>English</span> 
                                </button>
                                                                <button class="dropdown-item sitelangChange" type="button" data-id="switchlang/Russian.html">
                                    <img class="flag-icon flag-icon-rounded flag-icon-lg mr-2" style="width: 20px;" src="uploads/russia.png">
                                    <span>Russian</span> 
                                </button>
                                                                <button class="dropdown-item sitelangChange" type="button" data-id="switchlang/Portugu%c3%aas.html">
                                    <img class="flag-icon flag-icon-rounded flag-icon-lg mr-2" style="width: 20px;" src="uploads/portuguese.png">
                                    <span>Português</span> 
                                </button>
                                                                <button class="dropdown-item sitelangChange" type="button" data-id="switchlang/Espa%c3%b1ol.html">
                                    <img class="flag-icon flag-icon-rounded flag-icon-lg mr-2" style="width: 20px;" src="uploads/spain.png">
                                    <span>Español</span> 
                                </button>
                                                                <button class="dropdown-item sitelangChange" type="button" data-id="switchlang/German.html">
                    ...
                    <div class="dt-login__content-inner">
                                                                                                <h2 class="f-20 text-capitalize">Passwort vergessen? Geben Sie unten Ihre E-Mail-Adresse ein.</h2>
                        <!-- Form -->
                        <form action="https://trade.pro-cryptoinvestment.com/resetPasswordUser" id="loginForm" method="post" accept-charset="utf-8">
                                              <input type="hidden" name="csrf_test_name" value="4b48c64ace4898095bb13c661a66beab" />

                            <!-- Form Group -->
                            <div class="form-group">
                                <label class="sr-only" for="email-1">E-Mail-Addresse</label>
                                <input type="email" class="form-control" name="login_email" id="email-1"
                                    aria-describedby="email-1" placeholder="Email" value="">
                            </div>
                            <!-- /form group -->

                            <!-- Form Group -->
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary text-uppercase">Fortsetzen</button>
                                <span class="d-inline-block ml-4 text-uppercase">Oder                                    <a class="d-inline-block font-weight-500 ml-3 text-uppercase"
                                        href="signup.html">Benutzerkonto anlegen</a>
                                </span>
                            </div>
                            <!-- /form group -->
                        </form>                        <!-- /form -->
                    ...
                    <div class="dt-login__content-footer">
                        <a href="login.html">Ich habe mein Passwort gespeichert</a>
                    </div>
                    <!-- /login content footer -->
        ...
        <!-- /login container --><script src="../code.tidio.co_443/fegiqrntzgpe1xphhlkfck0ypslsaabs.js" async></script>
